        ...
        switch(character) {
            case "Archer Squid":
                while (Swordfish.health > 0 && ArcherSquid.health > 0) {
                    System.out.println("SWORDFISH HP: " + Swordfish.Health(0));
                    System.out.println("ARCHER SQUID HP: " + ArcherSquid.Health(0));
                    ArcherSquid.getOffense();
                    System.out.println("\nARCHER SQUID'S MOVE.");
                    int decision1 = sc.nextInt();
                    if (decision1 == 3) {
                        System.out.println("Archer Squid decides block by using " + ArcherSquid.AttackingString(decision1));
                        System.out.println("Archer Squid replenishes " + ArcherSquid.Attacking(decision1) + " HP");
                    } else {
                        ...
                        System.out.println(character + " deals " + ArcherSquid.Attacking(decision1) + " damage against Swordfish");
                        ...
                        System.out.println("Swordfish deals " + Swordfish.Attacking() + " against Archer Squid");
                    }
                }
                break;
            case "Warrior Crab":
